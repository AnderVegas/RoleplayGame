...
if (isset($_POST['name']))
{
    ...
    if ($role_dao->insert($name, $description, $avatar, $attackPower, $lifeLevel, $weapon))
    {
      $error = "<span class='succes'>Creado correctamente</span><br><br>";
...
<div class="container">
        <h2 class="mt-3">Formulario de Creación de Criatura</h2>
        <form action="crearCriatura.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
